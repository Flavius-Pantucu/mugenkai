...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-purple-600/10 blur-[150px] pointer-events-none" />
      ...
      >
        ...
        <div className="bg-[#0f0f14]/80 backdrop-blur-xl border border-purple-500/10 rounded-2xl p-8 shadow-2xl shadow-purple-500/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded bg-[#14141f] border-purple-500/20 accent-purple-500" />
                <span className="text-zinc-500" style={{ fontSize: "13px", fontWeight: 400 }}>Remember me</span>
              </label>
              <span className="text-purple-400 hover:text-purple-300 cursor-pointer" style={{ fontSize: "13px" }}>
                Forgot password?
              </span>
            </div>
          ...
          <p className="text-center mt-6 text-zinc-500" style={{ fontSize: "14px" }}>
            ...
            <Link to="/register" className="text-purple-400 hover:text-purple-300 transition-colors" style={{ fontWeight: 500 }}>
              Sign Up
            </Link>
          </p>
        </div>
